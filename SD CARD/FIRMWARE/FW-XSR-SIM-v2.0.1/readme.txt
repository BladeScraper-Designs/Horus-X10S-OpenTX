...
This Package is for XSR-SIM ACCST v2.0.1 firmware update. 

Version and Files: 
XSR-SIM_ACCST_V2.0.1_FCC.frk                                  Firmware under NonLbt mode which is certificated for FCC rules. 
XSR-SIM_ACCST_V2.0.1_LBT.frk                                   Firmware under LBT mode which is certificated for CE rules.  
