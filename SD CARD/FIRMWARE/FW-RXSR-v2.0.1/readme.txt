...
This Package is for RXSR ACCST v2.0.1 firmware update. 

Version and Files: 
RXSR_ACCST_V2.0.1_FCC.frk                                        Firmware under NonLbt mode which is certificated for FCC rules. 
RXSR_ACCST_V2.0.1_LBT.frk                                         Firmware under LBT mode which is certificated for CE rules.  
RXSR_ACCST_V2.0.1_Fport_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. F.Port protocol output supported.
RXSR_ACCST_V2.0.1_Fport_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  F.Port protocol output supported.
