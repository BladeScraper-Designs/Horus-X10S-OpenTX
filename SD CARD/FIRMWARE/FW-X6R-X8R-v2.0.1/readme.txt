...
This Package is for X6R/X8R SB ACCST v2.0.1 firmware update. 

Version and Files: 
X8R_ACCST_V2.0.1_FCC.frk                                  Firmware under NonLbt mode which is certificated for FCC rules. 
X8R_ACCST_V2.0.1_LBT.frk                                   Firmware under LBT mode which is certificated for CE rules.  
