...
This Package is for RX4R/RX6R ACCST v2.0.1 firmware update. 

Version and Files: 
RX6R_ACCST_V2.0.1_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. 
RX6R_ACCST_V2.0.1_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  
