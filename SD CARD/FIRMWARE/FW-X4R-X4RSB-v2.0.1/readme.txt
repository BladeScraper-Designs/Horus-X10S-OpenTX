...
This Package is for X4R/X4R SB ACCST v2.0.1 firmware update. 

Version and Files: 
X4R_ACCST_V2.0.1_FCC.frk                                  Firmware under NonLbt mode which is certificated for FCC rules. 
X4R_ACCST_V2.0.1_LBT.frk                                   Firmware under LBT mode which is certificated for CE rules.  
...
https://www.frsky-rc.com/product/x4r/
